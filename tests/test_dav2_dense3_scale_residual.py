...
from bim_priorda3.models.dav2_dense3_scale_residual import (
    ...
    build_dense3_scale_residual_condition,
...
def test_condition_order_has_no_disagreement_and_preserves_metric_scale():
    item = batch()
    condition = build_dense3_scale_residual_condition(item)
...
def test_log_depth_loss_is_equal_micro_macro_average():
...
def test_residual_head_is_exact_zero_at_initialization():
