...
run_name=f36_anchor_scale_gradient_epoch3_cached_zero_shot_20260905
...
checkpoint="$project_root/outputs/$model_run/epoch_003.pt"
...
echo "cache_bytes=$(du -sb "$cache_root" | awk '{print $1}')"
