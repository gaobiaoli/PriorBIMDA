...
run_name=stanford_area1_direct_low18_continuous_6epoch_20260907
...
log_path=/home/bgao491/tmp/direct_low18_continuous_6epoch_pipeline_20260907.log
status_path=/home/bgao491/tmp/direct_low18_continuous_6epoch_pipeline_20260907.status
commands_path=/home/bgao491/tmp/direct_low18_continuous_6epoch_pipeline_20260907.cmd
...
for checkpoint_label in best latest; do
  for scene in hxp 759 1px; do
    result_dir="$project_root/results/matterport3d/${scene}_direct_low18_continuous6_${checkpoint_label}_20260907_zero_shot"
...
{
  printf 'nohup setsid bash %q >/dev/null 2>&1 &\n' "$project_root/scripts/model/run_direct_low18_continuous_6epoch_pipeline_20260907.sh"
  printf 'tail -f %q\n' "$log_path"
  printf 'cat %q\n' "$status_path"
} >"$commands_path"
